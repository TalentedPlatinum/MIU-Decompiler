...
public partial class SerializerHelperImporter
{
    ...
    public void Read(ref MeshTunnelAnimator value)
    {
        // Special case for enabled. Skip if disabled.
        bool skipped = false;
        Stream.ReadBoolean(out skipped);
        value.enabled = skipped;
        ...
        Stream.ReadVector3(out outVec3);
        value.GridSize = new Vector3Int((int)outVec3.x, (int)outVec3.y, (int)outVec3.z);
        ...
        outVec3 = new Vector3();
        Stream.ReadVector3(out outVec3);
        value.LockBoxMin = new Vector3Int((int)outVec3.x, (int)outVec3.y, (int)outVec3.z);

        // Field Vector3Int
        outVec3 = new Vector3();
        Stream.ReadVector3(out outVec3);
        value.LockBoxMax = new Vector3Int((int)outVec3.x, (int)outVec3.y, (int)outVec3.z);
